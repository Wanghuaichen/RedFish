...
const float RTem[JointCount][16] = 
{
	...
	{0.1*KR+15, 17, 0.2*KR+15, 0.25*KR+15, 0.3*KR+15,0.35*KR+15,0.4*KR+15,0.45*KR+15,0.5*KR+15,0.55*KR+15,0.6*KR+15,0.7*KR+15,0.75*KR+15,0.8*KR+15,0.85*KR+15,0.95*KR+15},
};
//16种转弯值
